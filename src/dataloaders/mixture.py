        ...
        for n, idx in enumerate(idata):
            if idx == 0:
                ...
                dat["train"] = FashionMNIST(
                    os.path.join(data_path, "../data/fashion_mnist"),
                    train=True,
                    download=True,
                    transform=transforms.Compose(
                        [
                ...
                dat = {}
                dat["train"] = TrafficSigns(
                    os.path.join(data_path, "../data/traffic_signs"),
                    train=True,
                    download=True,
                    transform=transforms.Compose(
                        [transforms.ToTensor(), transforms.Normalize(mean, std)]
                ...
                dat = {}
                dat["train"] = Facescrub(
                    os.path.join(data_path, "../data/facescrub"),
                    train=True,
                    download=True,
                    transform=transforms.Compose(
                        [transforms.ToTensor(), transforms.Normalize(mean, std)]
                ...
                dat = {}
                dat["train"] = notMNIST(
                    os.path.join(data_path, "../data/notmnist"),
                    train=True,
                    download=True,
                    transform=transforms.Compose(
                        [transforms.ToTensor(), transforms.Normalize(mean, std)]
            ...
            for s in ["train", "test"]:
                ...
                torch.save(
                    data[n][s]["x"],
                    os.path.join(
                        os.path.expanduser(path), "data" + str(idx) + s + "x.bin"
                    ),
                )
                torch.save(
                    data[n][s]["y"],
                    os.path.join(
                        os.path.expanduser(path), "data" + str(idx) + s + "y.bin"
                    ),
                )
